...
class StockLevel extends DataClass implements Insertable<StockLevel> {
  ...
  @override
  int get hashCode =>
      Object.hash(productId, branchId, quantity, updatedAt, remoteId, isDirty);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is StockLevel &&
...
final class $$ProductsTableReferences
  ...
  static MultiTypedResultKey<$StockLevelsTable, List<StockLevel>>
  _stockLevelsRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.stockLevels,
    aliasName: $_aliasNameGenerator(db.products.id, db.stockLevels.productId),
  );

  $$StockLevelsTableProcessedTableManager get stockLevelsRefs {
    final manager = $$StockLevelsTableTableManager(
      $_db,
      $_db.stockLevels,
    ).filter((f) => f.productId.id.sqlEquals($_itemColumn<int>('id')!));

    final cache = $_typedResult.readTableOrNull(_stockLevelsRefsTable($_db));
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: cache),
    );
  }
...
class $$ProductsTableFilterComposer
  ...
  Expression<bool> stockLevelsRefs(
    Expression<bool> Function($$StockLevelsTableFilterComposer f) f,
  ) {
    final $$StockLevelsTableFilterComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.stockLevels,
...
class $$ProductsTableAnnotationComposer
  ...
  Expression<T> stockLevelsRefs<T extends Object>(
    Expression<T> Function($$StockLevelsTableAnnotationComposer a) f,
  ) {
    final $$StockLevelsTableAnnotationComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.stockLevels,
      getReferencedColumn: (t) => t.productId,
          ...
          prefetchHooksCallback:
              ({
                ...
                return PrefetchHooks(
                  db: db,
                  explicitlyWatchedTables: [
                    if (stockLevelsRefs) db.stockLevels,
                    if (stockMovementsRefs) db.stockMovements,
...
final class $$BranchesTableReferences
  ...
  _stockLevelsRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.stockLevels,
    aliasName: $_aliasNameGenerator(db.branches.id, db.stockLevels.branchId),
  );
  ...
  _stockMovementsRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.stockMovements,
    aliasName: $_aliasNameGenerator(db.branches.id, db.stockMovements.branchId),
  );
  ...
  _cashSessionsRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.cashSessions,
    aliasName: $_aliasNameGenerator(db.branches.id, db.cashSessions.branchId),
  );
...
final class $$StockLevelsTableReferences
    extends BaseReferences<_$AppDatabase, $StockLevelsTable, StockLevel> {
  $$StockLevelsTableReferences(super.$_db, super.$_table, super.$_typedResult);

  static $ProductsTable _productIdTable(_$AppDatabase db) =>
      db.products.createAlias(
        $_aliasNameGenerator(db.stockLevels.productId, db.products.id),
      );
  ...
  static $BranchesTable _branchIdTable(_$AppDatabase db) =>
      db.branches.createAlias(
        $_aliasNameGenerator(db.stockLevels.branchId, db.branches.id),
      );
...
class $$StockLevelsTableTableManager
    extends
        RootTableManager<
          ...
          (StockLevel, $$StockLevelsTableReferences),
          StockLevel,
        ...
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  e.readTable(table),
                  $$StockLevelsTableReferences(db, table, e),
                ),
              )
              .toList(),
                    ...
                    if (productId) {
                      state =
                          state.withJoin(
                                ...
                                referencedTable: $$StockLevelsTableReferences
                                    ._productIdTable(db),
                                referencedColumn: $$StockLevelsTableReferences
                                    ._productIdTable(db)
                                    .id,
                              )
                              as T;
...
final class $$StockMovementsTableReferences
  ...
  static $BranchesTable _branchIdTable(_$AppDatabase db) =>
      db.branches.createAlias(
        $_aliasNameGenerator(db.stockMovements.branchId, db.branches.id),
      );
...
class $$StockMovementsTableTableManager
    extends
        RootTableManager<
          ...
          StockMovement,
          PrefetchHooks Function({bool productId, bool branchId, bool userId})
        > {
    ...
    $StockMovementsTable table,
        ...
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback:
              ({productId = false, branchId = false, userId = false}) {
                return PrefetchHooks(
                  db: db,
                  explicitlyWatchedTables: [],
                  addJoins:
