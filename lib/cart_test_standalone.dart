...
void main() {
  debugPrint('Starting standalone cart test app');
...
class CartTestApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    debugPrint('Building CartTestApp');
    return MaterialApp(
...
class CartTestScreen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    debugPrint('Building CartTestScreen');
    return Scaffold(
      appBar: AppBar(
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                debugPrint('Building cart item $index: ${_sampleItems[index].name}');
                return CartItemWidget(item: _sampleItems[index]);
              },
            ),
          ),
...
class CartItemWidget extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    debugPrint('Building CartItemWidget for ${item.name}');
    return Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            Text(
                              'TK ${item.price.toStringAsFixed(2)} × ${item.quantity}',
                              style: TextStyle(
                                fontSize: 12,
                                color: Colors.grey.shade700,
                              ),
...
final List<CartItem> _sampleItems = [
  const CartItem(name: 'Ohi', price: 500.0, quantity: 1),
  const CartItem(name: 'Biscuit', price: 60.0, quantity: 1),
  const CartItem(name: 'Water', price: 10.0, quantity: 1),
  const CartItem(name: 'Mojo', price: 20.0, quantity: 1),
  const CartItem(name: 'Noodles', price: 60.0, quantity: 1),
  const CartItem(name: 'Rice', price: 1550.0, quantity: 1),
];
